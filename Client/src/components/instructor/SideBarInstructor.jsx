    ...
    return (
      <div className={classNames.wrapper}>
        <div className="flex flex-col items-center text-white mt-8">
          ...
          <h4 className={"text-text-accent-dark"}>Instructor</h4>
        </div>
          ...
          <div className={classNames.section + " mt-6"}>
            ...
            <ul className={classNames.list}>
              ...
              >
                <li className={classNames.listItem}>
                  <div className={classNames.listIconDiv}>
                    <SiCoursera className={classNames.listIcon} />
                  </div>
                  Courses
                </li>
              </NavLink>
              <NavLink
                to={`/instructor/${id}/addpromo`}
                className={({ isActive }) =>
                  isActive ? classNames.listLinkActive : classNames.listLink
                }
              >
              ...
              <NavLink to={`/instructor/${id}/addcourse`}  className={({ isActive }) =>
                  isActive ? classNames.listLinkActive : classNames.listLink
                }>
                <li className={classNames.listItem}>
                  <div className={classNames.listIconDiv}>
                    <MdAdd className={classNames.listIcon} />
                  </div>
                  Add Course
                </li>
              </NavLink>
              <NavLink to={`/instructor/${id}/problems`}  className={({ isActive }) =>
                  isActive ? classNames.listLinkActive : classNames.listLink
                }>
                <li className={classNames.listItem}>
                  <div className={classNames.listIconDiv}>
